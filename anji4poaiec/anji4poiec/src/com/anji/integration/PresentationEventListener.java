...
public class PresentationEventListener implements GeneticEventListener {
    ...
    private static final Logger logger = Logger.getLogger(PresentationEventListener.class.getName());
    ...
    public void storeRun(boolean isRunCompleted) {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "PresentationEventListener: error storing run", e);
        } finally {
            try {
                ...
                logger.severe("error closing presentation files");
            }
        }
    }
}
