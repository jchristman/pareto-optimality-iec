...
public abstract class TargetFitnessFunction implements EvaluationFunction, Configurable {
    ...
    private final long EVALUATION_FUNCTION_UUID = 1300L;
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                genotype.setFitnessValue(calculateErrorFitness(responses, activator.getMinResponse(),
                        activator.getMaxResponse()) - (int) (adjustForNetworkSizeFactor * genotype.size()),
                        this);
            } catch (TranscriberException e) {
                logger.warning("transcriber error: " + e.getMessage());
                genotype.setFitnessValue(1, this);
            }
        }
    }
    ...
    public long getEvaluationFunctionUUID() {
		return EVALUATION_FUNCTION_UUID;
    }
}
