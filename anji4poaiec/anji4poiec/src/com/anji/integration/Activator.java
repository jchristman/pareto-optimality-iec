...
/**
 * Although any object taking and returning double arrays can implement this, it
 * is meant to be a simple neural net interface where the arrays are input and
...
public interface Activator extends XmlPersistable {
     ...
     * <code>next(double[])</code> or
     * <code>next(double[][])</code>.
    ...
    /**
     * @param stimuli
     * @return double[] output array given input
     * <code>stimuli</code>.
     */
