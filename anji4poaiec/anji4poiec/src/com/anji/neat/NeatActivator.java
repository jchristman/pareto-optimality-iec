...
//	dimension # activation sets by dim response
     ...
     */
    public SortedMap<Integer, double[]> activate(String chromId) throws Exception {
     ...
     * @throws Exception
     */
    public SortedMap<Integer, double[]> activate(Activator activator) throws Exception {
        SortedMap<Integer, double[]> result = new TreeMap<Integer, double[]>();

        double[][] response = activator.next(stimuli);
        Iterator<Integer> it = idxs.iterator();
        while (it.hasNext()) {
    ...
    public String displayActivation(String chromId) throws Exception {
        ...
        Map<Integer, double[]> responses = activate(chromId);
        Iterator<Integer> it = responses.keySet().iterator();
        while (it.hasNext()) {
            Integer idx = (Integer) it.next();
            int i = idx.intValue();
