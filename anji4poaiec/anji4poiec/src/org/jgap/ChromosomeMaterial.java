...
public class ChromosomeMaterial implements Comparable<Object>, Serializable {
    ...
    public int compareTo(Object other) {
        ...
        while (iter.hasNext() && otherIter.hasNext()) {
            ...
            Class<? extends Allele> srcClass = allele.getClass();
            Class<? extends Allele> targetClass = otherAllele.getClass();
